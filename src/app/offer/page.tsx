...
// Metadata should be in a separate file when using "use client"
export default function OfferPage() {
  return (
    <div className="flex justify-center items-start py-10 px-4 bg-gradient-to-b from-gray-50 to-white min-h-screen">
      <div className="max-w-4xl w-full space-y-8">
        {/* Header Section */}
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-gray-900 mb-4">Система учёта заказов на металлообработку</h1>
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Профессиональное решение для цифровизации всех бизнес-процессов вашего производства
          </p>
        </div>
        ...
        <div className="text-center text-gray-500 text-sm mt-12">
          <p>© 2024 MetalSoft. Все технологии и подходы защищены законодательством РФ.</p>
          <p className="mt-1">Предложение действительно до 31.07.2024</p>
        </div>
      </div>
    </div>
  );
